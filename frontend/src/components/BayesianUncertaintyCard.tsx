        ...
        <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{
                        ...
                        background: 'linear-gradient(135deg, rgba(35, 83, 71, 0.2), rgba(35, 83, 71, 0.05))',
                    ...
                    <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                            ...
                            <span style={{
                                ...
                                background: 'rgba(35, 83, 71, 0.15)', color: 'var(--accent-primary)', border: '1px solid rgba(35, 83, 71, 0.3)'
                            }}>
                                UNIT I — BAYESIAN DAG
                            </span>
                        </div>
            ...
            {result && (
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 20 }}>
                    ...
                    <div style={{
                        background: 'rgba(35, 83, 71, 0.06)', border: '1px solid rgba(35, 83, 71, 0.25)',
                        borderRadius: 14, padding: 18
                    }}>
                        ...
                        {result.all_voi_rankings.map((test: any, idx: number) => {
                            ...
                            return (
                                <div key={test.id} style={{
                                    ...
                                    background: idx === 0 && !isCompleted ? 'rgba(35, 83, 71, 0.08)' : 'var(--surface-2)',
                                    border: idx === 0 && !isCompleted ? '1px solid rgba(35, 83, 71, 0.25)' : '1px solid var(--surface-border)',
