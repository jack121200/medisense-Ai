            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{
                        ...
                        background: 'linear-gradient(135deg, rgba(255,209,102,0.2), rgba(255,107,53,0.05))',
                        border: '1px solid rgba(255,209,102,0.3)',
                        display: 'flex', alignItems: 'center', justifyContent: 'center'
                    }}>
                        <Cpu size={22} color="#FFD166" />
                    </div>
                    <div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                            ...
                            <span style={{
                                ...
                                background: 'rgba(255,209,102,0.15)', color: '#FFD166', border: '1px solid rgba(255,209,102,0.3)'
                            }}>
                    ...
                    {DRUGS.map(d => (
                        <button
                            ...
                            style={{
                                ...
                                border: drug === d ? '1px solid #FFD166' : '1px solid rgba(255,255,255,0.08)',
                                background: drug === d ? 'rgba(255,209,102,0.15)' : 'rgba(255,255,255,0.03)',
                                color: drug === d ? '#FFD166' : 'var(--text-secondary)',
                                cursor: 'pointer'
                            }}
                        >
                            {d}
            ...
            {result && (
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 20 }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ fontSize: 11, color: '#FFD166', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                            💊 Centroid Defuzzified Dose
                        </div>
                        <div className="font-mono" style={{ fontSize: 30, fontWeight: 900, color: '#fff', marginTop: 4 }}>
                    ...
                    <div style={{
                        background: 'rgba(255,255,255,0.03)', border: `1px solid ${result.triage_color}40`,
                        borderRadius: 14, padding: 18
                    }}>
                    ...
                    <div style={{
                        ...
                        <div className="font-mono" style={{ fontSize: 24, fontWeight: 800, color: '#00E5FF', marginTop: 4 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16 }}>
                    <div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: 'var(--text-muted)', marginBottom: 4 }}>
                            ...
                            <strong style={{ color: '#fff' }}>{bp} mmHg</strong>
                        </div>
                        <input type="range" min={80} max={220} value={bp} onChange={e => setBp(Number(e.target.value))} style={{ width: '100%', accentColor: '#FFD166' }} />
                        <div style={{ fontSize: 10, color: '#FFD166', marginTop: 2 }}>
                    ...
                    <div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: 'var(--text-muted)', marginBottom: 4 }}>
                            ...
                            <strong style={{ color: '#fff' }}>{creatinine} mg/dL</strong>
                        </div>
                        <input type="range" min={0.6} max={4.5} step={0.1} value={creatinine} onChange={e => setCreatinine(Number(e.target.value))} style={{ width: '100%', accentColor: '#FFD166' }} />
                    ...
                    <div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 11, color: 'var(--text-muted)', marginBottom: 4 }}>
                            <span>Age</span>
                            <strong style={{ color: '#fff' }}>{age} yrs</strong>
                        </div>
                        <input type="range" min={18} max={90} value={age} onChange={e => setAge(Number(e.target.value))} style={{ width: '100%', accentColor: '#FFD166' }} />
                        <div style={{ fontSize: 10, color: '#C77DFF', marginTop: 2 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                        {result.active_rules_fired.map((r: any) => (
                            <div key={r.rule_id} style={{
                                ...
                                <div style={{ color: '#FFD166', fontWeight: 800, fontFamily: 'monospace' }}>
