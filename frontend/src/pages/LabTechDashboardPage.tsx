    ...
    return (
        <div style={{ padding: '32px 40px', maxWidth: 1100, margin: '0 auto' }}>
            <div style={{ marginBottom: 28 }}>
                <div style={{ fontSize: 11, color: 'var(--risk-high-text)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 6 }}>LAB TECHNICIAN — CBC UPLOAD</div>
                <h1 style={{ fontSize: 28, fontWeight: 900, color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: 12 }}>
                    <Microscope size={28} color="var(--risk-high-text)" /> CBC Report Upload Queue
                </h1>
            ...
            <div style={{ background: 'var(--surface-1)', border: '1px solid var(--surface-border)', borderRadius: 20, overflow: 'hidden' }}>
                <div style={{ padding: '16px 24px', borderBottom: '1px solid var(--surface-border)', display: 'flex', gap: 10, alignItems: 'center' }}>
                    <FlaskConical size={16} style={{ color: 'var(--risk-high-text)' }} />
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10 }}>
                                    <div>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
                                            ...
                                            <span style={{ fontSize: 11, color: 'var(--risk-high-text)', fontWeight: 700 }}>{req.testId}</span>
                                        </div>
                        ...
                        {uploadMode === 'pdf' && (
                            <div>
                                <div style={{ border: '2px dashed rgba(63, 138, 102, 0.25)', borderRadius: 14, padding: 32, textAlign: 'center', marginBottom: 16, background: pdfFile ? 'rgba(63, 138, 102, 0.05)' : 'transparent', cursor: 'pointer' }}
                                    ...
                                    {pdfFile
                                        ? <div style={{ fontWeight: 700, color: 'var(--risk-low-text)', fontSize: 14 }}>✅ {pdfFile.name}</div>
