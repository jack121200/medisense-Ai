...
export default function VitalsMonitorPage() {
    ...
    return (
        <div className="page-enter">
            ...
            <div style={{ marginBottom: 24 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
                    ...
                    <div style={{
                        ...
                        background: 'rgba(63, 138, 102, 0.08)', borderRadius: 9999,
                        border: '1px solid rgba(63, 138, 102, 0.20)',
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    background: isSelected ? 'rgba(35, 83, 71, 0.06)' : 'transparent',
                        ...
                        <div style={{
                            ...
                            {latestForSelected?.isAnomaly && (
                                <div style={{
                                    ...
                                    border: '1px solid rgba(200, 67, 75, 0.25)', fontSize: 11, fontWeight: 700, color: 'var(--risk-critical-text)',
                                }} className="pulse-critical">
            ...
            {alerts.length > 0 && (
                <div style={{
                    background: 'var(--surface-1)', border: '1px solid rgba(200, 67, 75, 0.20)',
                        ...
                        {alerts.slice(0, 8).map((a: any) => (
                            <div key={a.id} style={{
                                ...
                                <div style={{
                                    ...
                                    ...(a.severity === 'CRITICAL' ? { boxShadow: '0 0 8px rgba(200, 67, 75, 0.6)' } : {}),
                                }} />
