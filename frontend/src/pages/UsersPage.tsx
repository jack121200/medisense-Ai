...
const ROLE_COLORS: Record<string, { color: string; bg: string }> = {
    ADMIN: { color: '#FF2CF5', bg: 'rgba(142, 182, 155, 0.10)' },
    DOCTOR: { color: 'var(--accent-primary)', bg: 'rgba(35, 83, 71, 0.10)' },
    NURSE: { color: 'var(--risk-low-text)', bg: 'rgba(63, 138, 102, 0.10)' },
    ANALYST: { color: 'var(--risk-medium-text)', bg: 'rgba(201, 154, 42, 0.10)' },
};
            ...
            <div style={{ background: 'var(--surface-1)', border: '1px solid var(--surface-border)', borderRadius: 18, overflow: 'hidden' }}>
                {loading ? (
                    ...
                    <table className="data-table">
                        ...
                        <tbody>
                            {users.map((u: any) => {
                                const roleStyle = ROLE_COLORS[u.role] || { color: 'var(--text-secondary)', bg: 'var(--surface-2)' };
                                return (
                                    <tr key={u.id}>
                                        <td>
                                            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                                                <div style={{
                                                    ...
                                                    fontSize: 11, fontWeight: 800, color: 'var(--bg-primary)',
                                                }}>
                                        ...
                                        <td>
                                            <span style={{
                                                ...
                                                border: `1px solid ${u.isActive ? 'rgba(63, 138, 102, 0.20)' : 'rgba(200, 67, 75, 0.20)'}`,
                                            }}>
